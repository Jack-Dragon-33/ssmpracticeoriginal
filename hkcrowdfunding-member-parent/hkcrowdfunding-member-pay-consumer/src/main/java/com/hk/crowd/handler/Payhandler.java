...
import com.hk.crowd.config.PayProperties;
...
//——请在这里编写您的程序（以下代码仅作参考）——
/* 实际验证过程建议商户务必添加以下校验：1、需要验证该通知数据中的 out_trade_no 是否为商户系统中创建的订单号，
...
//AlipayConfig.logResult(sWord);
    ...
    public String returnUrlMethod(HttpServletRequest request) throws AlipayApiException,
...
// 若 想 给 BizContent 增 加 其 他 可 选 请 求 参 数 ， 以 增 加 自 定 义 超 时 时 间 参 数
        //timeout_express 来举例说明
